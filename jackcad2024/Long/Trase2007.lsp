...
;;;  (princ "B")
  ...
  (setq kt1 ktaw kt2 (+ ktaw 4) bg (+ ktaw 3)) ;;;; ini untuk lwpolyline kt2=ktaw+5   klu polyline kt2=ktaw+4
...
;;;================
  ...
  (while (= STOP1 0)
    ...
    (setq kt1 ktaw kt2 (+ ktaw 4) bg (+ ktaw 3) jarkum 0 jarkum4 0)
    (setq ttktnh1 nil)  
    (repeat putar     
      (setq gubel (cdr (nth bg ent)))
      (if (= gubel 0)
